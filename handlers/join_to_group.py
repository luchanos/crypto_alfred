        ...
        if user.get("join_to_group_count") == 1:
            ...
            if res.get("user_id"):
                await message.bot.send_message(
                    ...
                    text=_(
                        "You have been awarded by {count} " "rating points for an invited friend 💪",
                        locale=res.get("lang"),
                    ).format(count=REFERRAL_COUNT_FOR_COMMON_RATING),
                )
        else:
            ...
            if user_with_referral_link.get("user_id"):
                await message.bot.send_message(
                    ...
                    text=_(
                        ...
                        "invited friend was already in our group 😢",
