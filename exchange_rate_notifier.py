...
def make_rates_msg(rates):
    ...
    for rate in rates.rates:
        ...
        msg += f"\n{CURRENCY_RATE_MAPPER[rate.asset_id]} *{rate.name} \\({rate.asset_id}\\):" \
               f"* {formatted_price} $"
    return msg
...
if __name__ == "__main__":
    ...
    tg_client.send_message(chat_id=-1001654253357,
                           message=make_rates_msg(exchange_rates))
